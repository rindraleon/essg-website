      ...
      <ScrollableCardGrid className="mt-2 w-full">
        {formations.map((formation) => {
          ...
          return (
            <article
              key={formation.id}
              className={`${CARD_WIDTH_CLASS} group rounded-3xl overflow-hidden border border-gray-100 bg-white shadow-sm hover:shadow-sm transition-all duration-300 flex flex-col`}
            >
