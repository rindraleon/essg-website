    ...
    <section className="sticky top-24 z-40 border-b border-gray-200 bg-white shadow-sm">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between py-4">
          <span className="text-sm font-medium text-gray-600">{resultText}</span>
          ...
          <div className="flex items-center gap-1">
            {searchEnabled && onToggleSearch && (
              <Tooltip title={showSearch ? 'Fermer la recherche' : 'Rechercher'}>
                <IconButton
                  ...
                  sx={{
                    backgroundColor: showSearch ? GREEN[50] : 'transparent',
                    color: showSearch ? GREEN[700] : 'gray',
                    '&:hover': {
            ...
            <Tooltip title={showFilters ? 'Fermer les filtres' : 'Filtrer'}>
              <IconButton
                ...
                sx={{
                  backgroundColor: showFilters ? GREEN[50] : 'transparent',
