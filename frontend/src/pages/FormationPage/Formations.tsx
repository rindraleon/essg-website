...
const HERO_STATS = [
    ...
    },
    {
        ...
        icon: (
            <TrendingUpRoundedIcon sx={{ fontSize: 28, color: GREEN[300] }} />
        ),
    },
    {
        value: "15+",
...
const FormationsPage: React.FC = () => {
    ...
    const filteredFormations = useMemo(() => {
        ...
        return formations.filter((formation) => {
            ...
            const matchesNiveau =
                niveauFilter === "all" || formation.niveau === niveauFilter;
            const matchesDomaine =
                domaineFilter === "all" ||
                formation.domaine.includes(domaineFilter);
    ...
    const hasActiveFilters =
        searchTerm !== "" || niveauFilter !== "all" || domaineFilter !== "all";

    const activeFilterCount =
        (niveauFilter !== "all" ? 1 : 0) + (domaineFilter !== "all" ? 1 : 0);
